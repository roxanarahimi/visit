...
export default {
  ...
  setup(){
    ...
    let brands = [
      ...
      {type: 'ویفر', brands: ['کانتی','کوپا','تامبی','زر','چیچک','باراکا','بایکیت','شونیز']},
      {type: 'بیسکوییت', brands: ['کوپا','او کوپا', 'کلاب', 'ستاک', 'جمانه', 'درنا', 'گرجی', 'فرخنده', 'سلامت',]},

      {type: 'بیسکوییت پذیرایی', brands: ['کوپا','کوپا جو','کوپا گندم',]},
