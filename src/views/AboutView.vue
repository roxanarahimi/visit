...
export default {
  setup(){
    const data = ref([]);
    const getProducts = ()=>{
      axios.get('http://api.amadehlaziz.com:8877/panel/products?api_key=w2fqxjKzdlx345NjQ7D99xz5cPp')
          .then((response)=>{
          ...
          .then(()=>{
            ...
            axios.post('http://api.amadehlaziz.com:8877/form/products_by_ids?form_id='+localStorage.getItem('form_id')+'&api_key=mJF2qVIOq22K1LvNBp9gDiOcK8e2p', { ids })
                .then((response)=>{
                  if(response.data.length > 0){
                    ...
                    axios.get('http://api.amadehlaziz.com:8877/form/last_shop_data/'+query.value.shop_id+'?api_key=mJF2qVIOq22K1LvNBp9gDiOcK8e2p')
                    .then((res)=>{
    ...
    const submit = ()=>{
      ...
      axios.post('http://api.amadehlaziz.com:8877/form/add_products_to_form_data?api_key=mJF2qVIOq22K1LvNBp9gDiOcK8e2p',{
